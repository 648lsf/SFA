...
parser.add_argument('--output_dir', type=str, default='./output2/TIDIMI_inc_v3/', help='Output directory with adversarial images.') 
...
def DITIMI(images, gt, model, min, max):
    """
...
def main():
    ...
    for images, images_ID,  gt_cpu in tqdm(data_loader):
        ...
        adv_img = DITIMI(images, gt, model, images_min, images_max)
